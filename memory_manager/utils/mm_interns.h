...
/*   Updated: 2025/05/28 20:51:14 by ekrebs           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			mm_hashmap_init(t_mm *mm, t_content_hashmap *h, \
															size_t nb_buckets);
void			mm_hashmap_add(t_mm *mm, \
										t_content_hashmap *hashmap, void *elem);
void			mm_hashmap_remove(t_mm *mm, \
										t_content_hashmap *hashmap, void *elem);
