...
int		init_direction(t_mm *mm, t_parsing_map *parse, char *str, int dir, int fd);
int		process_direction(t_mm *mm, t_parsing_map *parse, char *line, int dir_i, int fd);
...
int		verif_colors(t_mm *mm, t_parsing_map *parse);
