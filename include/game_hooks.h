...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/28 09:31:13 by ekrebs            #+#    #+#             */
/*   Updated: 2025/05/28 09:32:30 by ekrebs           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define FRAME_TIME 0.0166  //(1.0 / TARGET_FPS)
...
void	ft_keys_mouse_player_rotations(t_game *game, \
									int32_t old_mouse_x, int32_t old_mouse_y);
